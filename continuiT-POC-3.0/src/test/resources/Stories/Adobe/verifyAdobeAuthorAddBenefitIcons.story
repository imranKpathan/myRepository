...
As an Author
I want to be able to log on to Adobe CEM and Add Benefit Icons to the test page

				 
Scenario:  1- verify the user is able to log on to Adobe CEM as an author and Add Benefit Icons to the test page
